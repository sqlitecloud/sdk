...
curl -X "PATCH" "https://web1.sqlitecloud.io:8443/dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64" \
...
```json
{
  name            = "ProjectName",              ; optional: Name of Project
  description     = "ProjectDescription",       ; optional: Description for Project
  admin_username  = "NodeLoginName",            ; optional: Internal name for loggin into the nodes
  admin_password  = "NodeLoginPassword",        ; optional: Internal password for loggin into the nodes
}
```
