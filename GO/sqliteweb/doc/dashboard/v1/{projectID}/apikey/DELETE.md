...
```sh
curl -X "DELETE" "https://web1.sqlitecloud.io:8443/dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/apikey" \
...
### **DELETE** - /dashboard/v1/{projectID}/apikey
...
```http
DELETE /dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/apikey HTTP/1.1
