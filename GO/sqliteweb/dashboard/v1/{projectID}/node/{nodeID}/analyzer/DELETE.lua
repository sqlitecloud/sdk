...
--   ///             ///   ///  ///
--   ///     //////////   ///  ///      Description : ANALYZER RESET ALL NODE ?
--     ////     //////////   ///        Requires    : Authentication
--        ////            ////          Output      : Delete all the analyzed queries
--          ////     /////                            on the specified node
--             ///                      Copyright   : 2022 by SQLite Cloud Inc.
--
-- -----------------------------------------------------------------------TAB=2

-- https://localhost:8443/dashboard/v1/dashboard/v1/{projectID}/node/{nodeID}/analyzer/
...
command = "ANALYZER RESET ALL NODE ?"
