...
--   ///             ///   ///  ///
--   ///     //////////   ///  ///      Description : ANALYZER RESET GROUPID ? NODE ?
--     ////     //////////   ///        Requires    : Authentication
--        ////            ////          Output      : Delete the analyzer queries for a particular database/sql group
--          ////     /////                            specified by the queryid of one query of that group
--             ///                      Copyright   : 2022 by SQLite Cloud Inc.
--
-- -----------------------------------------------------------------------TAB=2

-- https://localhost:8443/dashboard/v1/dashboard/v1/{projectID}/node/{nodeID}/analyzer/group/{queryID}
...
command = "ANALYZER RESET GROUPID ? NODE ?"
