...
func (this *ResultRow ) IsFirst() bool {
  switch {
  case this.result.GetNumberOfRows() < 1: return false
  default:            return this.index == 0
  }
}
...
func (this *ResultRow ) IsLast() bool { 
  switch {
  case this.result.GetNumberOfRows() < 1: return false
  default:                                return this.index == this.result.GetNumberOfRows() - 1
  }
}
...
func (this *ResultRow ) IsEOF() bool { 
  switch {
  case this.result.GetNumberOfRows() < 1: return true
  default:            return this.index >= this.result.GetNumberOfRows()
  }
}
...
func (this *ResultRow ) GetValue( Column uint64 ) ( *Value, error ) {
  switch {
  case Column >= this.GetNumberOfColumns(): return nil, errors.New( "Column index out of bounds" )
  default:            return &this.columns[ Column ], nil
  }
}
...
func (this *ResultRow ) GetNameLength( Column uint64 ) ( uint64, error ) { return this.result.GetNameLength( Column ) }
...
func (this *ResultRow ) GetMaxWidth( Column uint64 ) ( uint64, error ) { return this.result.GetMaxColumnWidth( Column ) }
...
func (this *ResultRow ) IsInteger( Column uint64 ) bool { 
  switch value, err := this.GetValue( Column ); {
  case err != nil:    return false
  case value == nil:  return false
  default:            return value.IsInteger()
  }
}
...
func (this *ResultRow ) IsText( Column uint64 ) bool {
  ...
  case err != nil:    return false
  case value == nil:  return false
  default:            return value.IsText()
  }
}

// GetStringValue returns the contents in column Column of this query result row as string.
// The Column index is an unsigned int in the range of 0...GetNumberOfColumns() - 1.
func (this *ResultRow ) GetString( Column uint64 ) ( string, error ) { return this.result.GetStringValue( this.index, Column ) }

// GetInt32Value returns the contents in column Column of this query result row as int32.
// The Column index is an unsigned int in the range of 0...GetNumberOfColumns() - 1.
func (this *ResultRow ) GetInt32( Column uint64 ) ( int32, error ) { return this.result.GetInt32Value( this.index, Column ) }

// GetInt64Value returns the contents in column Column of this query result row as int64.
// The Column index is an unsigned int in the range of 0...GetNumberOfColumns() - 1.
func (this *ResultRow ) GetInt64( Column uint64 ) ( int64, error ) { return this.result.GetInt64Value( this.index, Column ) }

// GetFloat32Value returns the contents in column Column of this query result row as float32.
// The Column index is an unsigned int in the range of 0...GetNumberOfColumns() - 1.
func (this *ResultRow ) GetFloat32( Column uint64 ) ( float32, error ) { return this.result.GetFloat32Value( this.index, Column ) }

// GetFloat64Value returns the contents in column Column of this query result row as float64.
// The Column index is an unsigned int in the range of 0...GetNumberOfColumns() - 1.
func (this *ResultRow ) GetFloat64( Column uint64 ) ( float64, error ) { return this.result.GetFloat64Value( this.index, Column ) }

// GetSQLDateTime parses this query result value in column Column as an SQL-DateTime and returns its value.
// The Column index is an unsigned int in the range of 0...GetNumberOfColumns() - 1.
func (this *ResultRow ) GetSQLDateTime( Column uint64 ) ( time.Time, error ) { return this.result.GetSQLDateTime( this.index, Column ) } 
...
func (this *ResultRow) renderValue( Column uint64, Quotation string, NullValue string ) string {
  ...
  if val, err := this.GetValue( Column ); err != nil {
    ...
    switch {
    case val.IsNULL():    return NullValue
    case val.IsText():    return val.GetString()
    default:              return fmt.Sprintf( "%s%s%s", Quotation, val.GetString(), Quotation )
    }
  }
}
...
func (this *ResultRow) renderLine( Format int, Separator string, NullValue string, NewLine string, MaxLineLength uint ) string {
  ...
  for forThisColumn := uint64( 0 ); forThisColumn < this.result.GetNumberOfColumns(); forThisColumn++ {
    ...
    case OUTFORMAT_MARKDOWN, OUTFORMAT_TABLE, OUTFORMAT_BOX:  buffer += fmt.Sprintf( fmt.Sprintf( " %%-%ds %s", maxWidth, Separator ), this.renderValue( forThisColumn, "", NullValue ) ) 
    case OUTFORMAT_CSV:                                       buffer += fmt.Sprintf( "%s,", SQCloudEnquoteString( this.renderValue( forThisColumn, "", NullValue ) ) )
    case OUTFORMAT_LINE:                                      buffer += trimStringToMaxLength( fmt.Sprintf( fmt.Sprintf( "%%%ds = %%s", this.result.MaxHeaderWidth ), columnName, this.renderValue( forThisColumn, "", NullValue ) ), MaxLineLength ) + NewLine
    ...
    case OUTFORMAT_XML:                                       buffer += trimStringToMaxLength( fmt.Sprintf( "    <field name=\"%s\">%s</field>", columnName, html.EscapeString( this.renderValue( forThisColumn, "", NullValue ) ) ), MaxLineLength ) + NewLine
    }
  }
  switch Format {
