...
```sh
curl -X "DELETE" "https://web1.sqlitecloud.io:8443/dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/node/6/connection/7" \
...
### **DELETE** - /dashboard/v1/{projectID}/node/{nodeID}/connection/{connectionID}
...
```http
DELETE /dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/node/6/connection/7 HTTP/1.1
