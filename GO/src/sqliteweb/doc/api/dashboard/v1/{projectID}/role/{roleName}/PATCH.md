...
```sh
curl -X "PATCH" "https://web1.sqlitecloud.io:8443/dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/role/MYROLE" \
...
### **PATCH** - /dashboard/v1/{projectID}/role/{roleName}
...
```
PATCH /dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/role/MYROLE HTTP/1.1
