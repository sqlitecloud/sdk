...
```sh
curl -X "POST" "https://web1.sqlitecloud.io:8443/dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/privilege/ADMIN/READ/" \
...
```
POST /dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/privilege/ADMIN/READ/ HTTP/1.1
