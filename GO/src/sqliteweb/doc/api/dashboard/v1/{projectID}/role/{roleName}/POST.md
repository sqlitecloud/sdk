...
```sh
curl -X "POST" "https://web1.sqlitecloud.io:8443/dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/role/MYROLE" \
...
### **POST** - /dashboard/v1/{projectID}/role/{roleName}

### Request object

```code
{
  privilege        = "READ",          // Comma separated list of privilege
...
Date: Fri, 18 Mar 2022 09:57:35 GMT
Content-Length: 29
Connection: close
