...
```sh
curl -X "DELETE" "https://web1.sqlitecloud.io:8443/dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/database/x/table/xx" \
...
### **DELETE** - /dashboard/v1/{projectID}/database/{databaseName}/table/{tableName}
...
```http
DELETE /dashboard/v1/fbf94289-64b0-4fc6-9c20-84083f82ee64/database/x/table/table1 HTTP/1.1
