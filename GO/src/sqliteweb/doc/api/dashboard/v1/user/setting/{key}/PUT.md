...
```sh
curl -X "PUT" "https://web1.sqlitecloud.io:8443/dashboard/v1/user/setting/testkey" \
...
### **PUT** - /dashboard/v1/user/setting/testkey

### Request object

```code
{
  value           = "SomeValue2",        ; Data as string
}
```
...
```
PUT /dashboard/v1/user/setting/testkey HTTP/1.1
