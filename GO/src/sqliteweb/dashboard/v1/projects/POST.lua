...
if userID == 0 then return error( 501, "Not Implemented" )
  ...
  for i = 1, 20 do
    ...
    query = string.format( "INSERT INTO Project VALUES( '%s', %d, '%s', '%s', '%s', '%s' ); SELECT changes() AS success;", enquoteSQL( Project.id ), userID, enquoteSQL( name ), enquoteSQL( description ), enquoteSQL( adminUsername ), enquoteSQL( adminPassword ) )
