...
if not body.enabled                       then body.enabled = true                          end
if body.enabled               == "TRUE"   then body.enabled = true                          end
if body.enabled               == "true"   then body.enabled = true                          end
if body.enabled               == "1"      then body.enabled = true                          end
if body.enabled               == 1        then body.enabled = true                          end
if not body.enabled                       then body.enabled = false                         end
