...
if not body.password                      then return error( 400, "Missing new password" )  end

query = string.format( "SET PASSWORD '%s' USER '%s';", enquoteSQL( body.password ), enquoteSQL( userName ) )
